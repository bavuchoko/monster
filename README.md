# 게시판 기본 CRUD 와 rest api 기본 기능을 익히기 위한 프로젝트 
 sql 위주의 전자정부 프레임워크 기반 웹 서비스 개발에서 벗어나 확장성 좋은 rest api 기법을 공부하기 위하여
 [ springboot, rest-api, jpa, hibernate, mariaDb, redis, ubuntu, jenkins ] 를 활용하여 기본 게시판 crud 부터 시작하여 공부하며 다양한 기능이나 서비스들을 모듈화 하여 추가해 나가는것이 목표.   
